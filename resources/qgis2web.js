...
map.getView().fit([-115035.187161, 8989531.114177, 429634.225426, 9270868.620679], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Provincia de La Libertad</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (107 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado para el curso de Cartografía y SIG <br />UPN - 2025<br />Ing. Maria Mercedes Gamboa Castillo ';
            }
